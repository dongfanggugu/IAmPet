...
function getElevatorBaseInfo(){
	...
	$.ajax({
           type: "GET",
			url: "http://elevator.hbydt.cn/analysis/baseinfo",			
			cache:false,
			async:false,
			dataType: "json",
...
function getAnalysisReference(){
	$.ajax({
           type: "POST",
			url: "http://elevator.hbydt.cn/analysis/reference",		
			cache:false,
			async:false,
			dataType: "json",
			data: {"sn":elevatorSn}, //参数之间用“,” 逗号隔开。
...
function getAnalysisAcc(time){
	...
	$.ajax({
           type: "POST",
			url: "http://elevator.hbydt.cn/analysis/acc",		
			cache:false,
			async:true,
			dataType: "json",
...
function getAnalysisVeloc(time){
	...
	$.ajax({
           type: "POST",
			url: "http://elevator.hbydt.cn/analysis/veloc",		
			cache:false,
			async:true,
			dataType: "json",
			data: {'sn':elevatorSn,'st':time,'n':15}, //参数之间用“,” 逗号隔开。
...
function getAnalysisTraffic(time){	
	...
	$.ajax({
           type: "POST",
			url: "http://elevator.hbydt.cn/analysis/traffic",		
			cache:false,
			async:true,
			dataType: "json",
...
function getAnalysisTrajectory(time){
	...
	$.ajax({
           type: "POST",
			url: "http://elevator.hbydt.cn/analysis/trajectory",		
			cache:false,
			async:true,
			dataType: "json",
